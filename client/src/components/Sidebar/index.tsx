...
const Sidebar = () => {
  ...
  const sidebarClassNames = `fixed flex flex-col h-[100%] justify-between shadow-xl bg-white transition-all duration-300 z-40 bg-white overflow-y-auto dark:bg-black ${isSidebarCollapsed ? "w-0 hidden" : "w-64"}`;
        ...
        <div className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700">
          ...
          <div>
            ...
            <div className="flex items-start gap-2">
              <LockIcon className="mt-[0.1rem] h-3 w-3 dark:text-gray-100" />
