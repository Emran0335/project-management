      ...
      <div className="mb-3 flex w-full">
        ...
        <div className="flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4 dark:bg-dark-secondary">
          ...
          <div className="flex items-center gap-1">
            <button className="flex h-5 w-5 items-center justify-center dark:text-neutral-500">
  ...
  return (
    ...
    >
      {task.attachments && task.attachments.length > 0 && (
        <Image
          src={`https://pm-s-3-images.s3.ap-south-1.amazonaws.com/${task.attachments[0].fileURL}`}
      ...
      <div className="p-4 md:p-6">
        ...
        <div className="my-3 flex justify-between">
          <h1 className="text-sm font-bold dark:text-white">{task.title}</h1>
        ...
        <div className="mt4 border-t border-gray-200 dark:border-stroke-dark">
          {/* USER  */}
            ...
            <div className="flex -space-x-[6px] overflow-hidden">
              {task.assignee && (
                <Image
                  ...
                  src={`https://pm-s-3-images.s3.ap-south-1.amazonaws.com/${task.assignee.profilePictureUrl!}`}
              ...
              {task.author && (
                <Image
                  ...
                  src={`https://pm-s-3-images.s3.ap-south-1.amazonaws.com/${task.author.profilePictureUrl!}`}
